...
/**
 * Class PindahKuliahLuarNegeriCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class PindahKuliahLuarNegeriCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('pindahkuliahluarnegeri', 'Pindah Kuliah ke Luar Negeri');
        ...
        CRUD::column('no_surat')->wrapper(
            [
                'href' => function ($crud, $column, $entry, $related_key) {
                    return backpack_url('pindah-kuliah-luar-negeri/' . $entry->id . '/show');
                },
    ...
    {
        CRUD::setValidation(PindahKuliahLuarNegeriRequest::class);

        CRUD::field('no_surat')
            ->default(Helper::generateId(
                PindahKuliahLuarNegeri::class,
                'no_surat',
                'M/KLN',
                4 ))
            ->attributes([
    ...
    public function print($id){
        ...
        $filename = 'pindah-kuliah-luar-negeri' . $izin->user->name;
