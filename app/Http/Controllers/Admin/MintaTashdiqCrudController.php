...
/**
 * Class MintaTashdiqCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class MintaTashdiqCrudController extends CrudController
{
        ...
        CRUD::column('no_surat')->wrapper(
            [
                'href' => function ($crud, $column, $entry, $related_key) {
                    return backpack_url('mintatashdiq/' . $entry->id . '/show');
                },
    ...
    public function approve($id){
        ...
        Alert::success('Pengantar permintaan tashdiq berhasil disetujui')->flash();
        return redirect('admin/mintatashdiq');
    }
    ...
    public function print($id){
        ...
        $filename = 'minta-tashdiq_' . $izin->user->name;
