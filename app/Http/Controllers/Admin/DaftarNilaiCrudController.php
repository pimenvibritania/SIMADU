...
use App\Http\Requests\DaftarNilaiRequest;
...
/**
 * Class DaftarNilaiCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class DaftarNilaiCrudController extends CrudController
{
        ...
        CRUD::column('no_surat')->wrapper(
            [
                'href' => function ($crud, $column, $entry, $related_key) {
                    return backpack_url('daftarnilai/' . $entry->id . '/show');
                },
    ...
    {
        CRUD::setValidation(DaftarNilaiRequest::class);
    ...
    public function approve($id){
        ...
        Alert::success('Pengantar permintaan daftar nilai berhasil disetujui')->flash();
        return redirect('admin/daftarnilai');
    }
    ...
    public function print($id){
        ...
        $filename = 'daftar-nilai_' . $izin->user->name;
