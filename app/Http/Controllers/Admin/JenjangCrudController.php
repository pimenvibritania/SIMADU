...
/**
 * Class JenjangCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class JenjangCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Jenjang::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/jenjang');
        CRUD::setEntityNameStrings('jenjang', 'Master Jenjang');
