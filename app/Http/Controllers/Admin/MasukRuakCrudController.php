...
use App\Http\Requests\MasukRuakRequest;
...
/**
 * Class MasukRuakCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class MasukRuakCrudController extends CrudController
{
        ...
        CRUD::column('no_surat')->wrapper(
            [
                'href' => function ($crud, $column, $entry, $related_key) {
                    return backpack_url('masukruak/' . $entry->id . '/show');
                },
    ...
    {
        CRUD::setValidation(MasukRuakRequest::class);
    ...
    public function approve($id){
        ...
        Notification::send($kb->user,
            new MasukRuakNotification($kb));

        Alert::success('Keterangan masuk ruak berhasil disetujui')->flash();
        return redirect('admin/masukruak');
    }

    public function decline($id){
        MasukRuak::find($id)->update([
            'status' => 'ditolak'
        ]);
    }
    ...
    public function print($id){
        ...
        $filename = 'masuk-ruak_' . $izin->user->name;
