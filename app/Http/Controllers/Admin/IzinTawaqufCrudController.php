...
use App\Http\Requests\IzinTawaqufRequest;
...
/**
 * Class IzinTawaqufCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class IzinTawaqufCrudController extends CrudController
{
        ...
        CRUD::column('no_surat')->wrapper(
            [
                'href' => function ($crud, $column, $entry, $related_key) {
                    return backpack_url('izintawaquf/' . $entry->id . '/show');
                },
    ...
    {
        CRUD::setValidation(IzinTawaqufRequest::class);
    ...
    public function approve($id){
        ...
        Alert::success('Pengantar izin tidak mengikuti uzian (tawaquf) berhasil disetujui')->flash();
        return redirect('admin/izintawaquf');
    }
    ...
    public function print($id){
        ...
        $filename = 'izin-tawaquf_' . $izin->user->name;
