...
/**
 * Class IzinSakitCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class IzinSakitCrudController extends CrudController
{
        ...
        CRUD::column('no_surat')->wrapper(
            [
                'href' => function ($crud, $column, $entry, $related_key) {
                    return backpack_url('izinsakit/' . $entry->id . '/show');
                },
    ...
    {
        CRUD::setValidation(IzinSakitRequest::class);
    ...
    public function approve($id){
        ...
        Alert::success('Pengantar izin sakit berhasil disetujui')->flash();
        return redirect('admin/izinsakit');
    }
    ...
    public function print($id){
        ...
        $filename = 'izin-sakit_' . $izin->user->name;
