...
use App\Http\Requests\CustomLetterRequest;
...
/**
 * Class CustomLetterCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class CustomLetterCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Mahasiswa\CustomLetter::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/customletter');
        CRUD::setEntityNameStrings('customletter', 'custom_letters');
    ...
    {
        CRUD::setValidation(CustomLetterRequest::class);
