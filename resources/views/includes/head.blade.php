...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('assets/vendor/icofont/icofont.min.css')}}">
    ...
    <link rel="stylesheet" href="{{URL::asset('assets/vendor/line-awesome/css/line-awesome.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('assets/vendor/venobox/venobox.min.css')}}">
    ...
    <link id="pagestyle" href="{{URL::asset('assets/vendor/css/soft-ui-dashboard.css')}}" rel="stylesheet" />
