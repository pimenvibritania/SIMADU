...
@section('content')
    ...
    <div class="col-md-4 mb-3">
        <a href="{{route('ket-non-beasiswa.index')}}" class="btn btn-danger" >
    ...
    <div class="register">
        <div class="row">
            <div class="col-md-3 register-left">
                ...
                <h3>KETERANGAN TIDAK MENERIMA BEASISWA</h3>
                <p>Pengajuan Keterangan Tidak Menerima Beasiswa</p>
            </div>
            <div class="col-md-9 register-right">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h3 class="register-heading">Silahkan lengkapi form di bawah</h3>
                        <form class="row register-form" method="POST" action="{{route('ket-non-beasiswa.store')}}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        @endif
                                            <input type="number" min="1" class="form-control" placeholder="Tahun Ajaran"
                                                   name="thn_ajaran" />
