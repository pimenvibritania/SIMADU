    ...
    <div class="container">
        <div class="row">
            <div class="col mb-3 ">
                ...
                <a href="{{route('tidak-keluar-negeri.create')}}" class="btn mybtn text-right" >
        ...
        <div class="panel-body">
            <h3 class="text-center m-3">Surat keterangan tidak keluar Negeri yang telah diajukan</h3>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('tidak-keluar-negeri.index') }}",
                columns: [
                    {data: 'id', name: 'id'},
