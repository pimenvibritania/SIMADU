...
@section('content')
    ...
    <div class="container" id="booking">
        <div class="row">
            <div class="col">
                <a href="{{route('pindah-kuliah-indonesia.index')}}" class="btn btn-danger" >
        ...
        <div>
            <div class="text-center">
                <h1>PINDAH KULIAH KE INDONESIA</h1>
                <p>Pengajuan Surat Pindah Kuliah ke Indonesia</p>
            </div>
            <div class="container mt-5">
                <div class="booking-form">
                    <h3 class="register-heading text-center mb-3">Silahkan lengkapi form di bawah</h3>

                    <form method="POST" action="{{route('pindah-kuliah-indonesia.store')}}"
