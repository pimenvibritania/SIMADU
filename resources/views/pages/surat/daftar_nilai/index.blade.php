    ...
    <div class="container">
        <div class="row">
            <div class="col mb-3 ">
                ...
                <a href="{{route('daftar-nilai.create')}}" class="btn mybtn text-right" >
        ...
        <div class="panel-body">
            <h3 class="text-center m-3">Surat Pengantar Permintaan Daftar Nilai</h3>
