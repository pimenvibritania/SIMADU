    ...
    <div class="container">
        <div class="row">
            <div class="col mb-3 ">
                ...
                <a href="{{route('izin-sakit.create')}}" class="btn mybtn text-right" >
        ...
        <div class="panel-body">
            <h3 class="text-center m-3">Surat Pengantar Izin Tidak Ikut Ujian Karena Sakit</h3>
