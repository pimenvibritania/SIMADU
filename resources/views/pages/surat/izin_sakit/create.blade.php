...
@section('content')
    ...
    <div class="col-md-4 mb-3">
        <a href="{{route('izin-libur.index')}}" class="btn btn-danger" >
    ...
    <div class="register">
        <div class="row">
            <div class="col-md-3 register-left">
                ...
                <h3>PENGANTAR IZIN SAKIT</h3>
                <p>Pengajuan Pengantar Izin Tidak Ikut Ujian Karena Sakit</p>
            </div>
            <div class="col-md-9 register-right">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h3 class="register-heading">Silahkan lengkapi form di bawah</h3>
                        <form class="row register-form" method="POST" action="{{route('izin-sakit.store')}}"
