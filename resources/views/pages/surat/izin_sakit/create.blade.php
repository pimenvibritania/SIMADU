...
@section('content')
    ...
    <div class="container" id="booking">
        <div class="row">
            <div class="col">
                <a href="{{route('izin-sakit.index')}}" class="btn btn-danger" >
        ...
        <div>
            <div class="text-center">
                <h1>PENGANTAR IZIN SAKIT</h1>
                <p>Pengajuan Pengantar Tidak Mengikuti Ujian Karena Sakit</p>
            </div>
            <div class="container mt-5">
                <div class="booking-form">
                    <h3 class="register-heading text-center mb-3">Silahkan lengkapi form di bawah</h3>

                    <form method="POST" action="{{route('izin-sakit.store')}}"
