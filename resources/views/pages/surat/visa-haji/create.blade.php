...
@section('content')
    ...
    <div class="col-md-4 mb-3">
        <a href="{{route('visa-haji.index')}}" class="btn btn-danger" >
            ...
            <div class="col-md-9 register-right">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form class="row register-form" method="POST" action="{{route('visa-haji.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <ul>
