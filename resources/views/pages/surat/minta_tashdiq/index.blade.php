    ...
    <div class="container">
        <div class="row">
            <div class="col mb-3 ">
                ...
                <a href="{{route('minta-tashdiq.create')}}" class="btn mybtn text-right" >
        ...
        <div class="panel-body">
            <h3 class="text-center m-3">Surat Pengantar Permintaan Tashdiq</h3>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('minta-tashdiq.index') }}",
                columns: [
                    {data: 'id', name: 'id'},
