...
@section('content')
    ...
    <div class="col-md-4 mb-3">
        <a href="{{route('alamat-mesir.index')}}" class="btn btn-danger" >
    ...
    <div class="register">
        <div class="row">
            <div class="col-md-3 register-left">
                ...
                <h3>KET ALAMAT MESIR</h3>
                <p>Pengajuan Surat <br> Keterangan Alamat di Mesir</p>
            </div>
            <div class="col-md-9 register-right">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h3 class="register-heading">Silahkan lengkapi form di bawah</h3>
                        <form class="row register-form" method="POST" action="{{route('alamat-mesir.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <ul>
