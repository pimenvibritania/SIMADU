...
@section('content')
    ...
    <div class="col-md-4 mb-3">
        <a href="{{route('masuk-mahad.index')}}" class="btn btn-danger" >
    ...
    <div class="register">
        <div class="row">
            <div class="col-md-3 register-left">
                ...
                <h3>DAFTAR MASUK MA'HAD</h3>
                <p>Pengajuan Daftar Masuk Ma'had</p>
            </div>
            <div class="col-md-9 register-right">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h3 class="register-heading">Silahkan lengkapi form di bawah</h3>
                        <form class="row register-form" method="POST" action="{{route('masuk-mahad.store')}}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <select name="jenjang" class="form-control">
                                                <option value="" aria-disabled="true">Pilih Jenjang</option>
                                            @foreach($jenjang as $jenj)
                                                <option value="{{$jenj}}">{{$jenj}}</option>
                                            @endforeach
                                        </select>
                                    </div>
