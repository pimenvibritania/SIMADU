    ...
    <div class="container" id="booking">
        ...
        <div>
            <div class="text-center">
                <h1>DAFTAR MASUK MA'HAD</h1>
                <p>Pengajuan Surat Daftar Masuk Ma'had</p>
            </div>
            <div class="container mt-5">
                <div class="booking-form">
                    <h3 class="register-heading text-center mb-3">Silahkan lengkapi form di bawah</h3>

                    <form method="POST" action="{{route('masuk-mahad.store')}}"
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <span class="form-label">Pilih Jenjang Pendidikan</span>
