    ...
    <div class="container">
        <div class="row">
            <div class="col mb-3 ">
                ...
                <a href="{{route('pindah-fakultas.create')}}" class="btn mybtn text-right" >
        ...
        <div class="panel-body">
            <h3 class="text-center m-3">Surat Keterangan Pindah Fakultas</h3>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('pindah-fakultas.index') }}",
                columns: [
                    {data: 'id', name: 'id'},
