    ...
    <div class="container">
        <div class="row">
            <div class="col mb-3 ">
                ...
                <a href="{{route('masuk-kuliah.create')}}" class="btn mybtn text-right" >
        ...
        <div class="panel-body">
            <h3 class="text-center m-3">Surat Pengajuan Daftar Kuliah</h3>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('masuk-kuliah.index') }}",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'no_surat', name: 'no_surat'},
                    {data: 'no_permohonan', name: 'no_permohonan'},
                    {data: 'fakultas', name: 'fakultas_id'},
                    {data: 'kampus', name: 'fakultas_id'},
